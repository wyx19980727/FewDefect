...
# python ./MMdet/tools/train.py \
#     /home/dlsuncheng/FSOD/FsMMdet/Model/full_data/frcn_all_contrast_zero_dce.py \
#     --gpu-ids 0

CUDA_VISIBLE_DEVICES=0,1 bash ./MMdet/tools/dist_test.sh \
    ./Model/full_data/frcn_all_contrast_zero_dce.py \
    /home/dlsuncheng/Work_dir/FsMMdet/20211103/FRCN_all/contrast_zero_dce/best_bbox_mAP.pth \
    2 \
    --eval bbox \
