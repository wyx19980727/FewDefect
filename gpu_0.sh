...
# python ./MMdet/tools/train.py \
#     /home/dlsuncheng/FSOD/FsMMdet/Model/full_data/frcn_all_contrast.py \
#     --gpu-ids 0

CUDA_VISIBLE_DEVICES=2,3 bash ./MMdet/tools/dist_test.sh \
    ./Model/full_data/frcn_all_contrast.py \
    /home/dlsuncheng/Work_dir/FsMMdet/20211103/FRCN_all/contrast/best_bbox_mAP.pth \
    2 \
    --eval bbox \
